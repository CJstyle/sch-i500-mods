...
.method tickerDone()V
    ...
    invoke-static {v0}, Lcom/android/server/status/StatusBarService;->access$800(Lcom/android/server/status/StatusBarService;)Landroid/view/View;
    ...
    invoke-static {v1, v4, v2}, Lcom/android/server/status/StatusBarService;->access$900(Lcom/android/server/status/StatusBarService;ILandroid/view/animation/Animation$AnimationListener;)Landroid/view/animation/Animation;
    ...
    invoke-static {v1, v2, v3}, Lcom/android/server/status/StatusBarService;->access$900(Lcom/android/server/status/StatusBarService;ILandroid/view/animation/Animation$AnimationListener;)Landroid/view/animation/Animation;
...
.method tickerStarting()V
    ...
    invoke-static {v0, v1}, Lcom/android/server/status/StatusBarService;->access$702(Lcom/android/server/status/StatusBarService;Z)Z
    ...
    invoke-static {v1, v2, v5}, Lcom/android/server/status/StatusBarService;->access$900(Lcom/android/server/status/StatusBarService;ILandroid/view/animation/Animation$AnimationListener;)Landroid/view/animation/Animation;
    ...
    invoke-static {v1, v4, v5}, Lcom/android/server/status/StatusBarService;->access$900(Lcom/android/server/status/StatusBarService;ILandroid/view/animation/Animation$AnimationListener;)Landroid/view/animation/Animation;
