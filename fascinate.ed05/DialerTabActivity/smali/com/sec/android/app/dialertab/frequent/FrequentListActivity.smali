...
.method private callOrSmsContact(I)V
    ...
    const-string v9, "FrequentListActivty"
    ...
    .line 1501
    .local v0, contact_id:I
    const/4 v3, 0x0

    .line 1503
    .local v3, phonesCursor:Landroid/database/Cursor;
    ...
    .line 1508
    :cond_0
    iget-object v5, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->viewData:Lcom/sec/android/app/dialertab/frequent/FrequentListActivity$ViewData;

    iget v5, v5, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity$ViewData;->contact_id:I
    ...
    iget v0, v5, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity$ViewData;->contact_id:I
    ...
    invoke-direct {p0, v5, v6}, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->queryPhoneNumbers(J)Landroid/database/Cursor;
    ...
    .line 1523
    :cond_2
    const-string v5, "FrequentListActivty"

    const-string v5, "phonesCursor == null || phonesCursor.getCount() == 0"
    ...
    invoke-static {p0, v5}, Lcom/sec/android/app/dialertab/calllog/CallLogUtil;->makeCall(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p0, v5}, Lcom/sec/android/app/dialertab/calllog/CallLogUtil;->makeSms(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {v2, p0, v3, v4}, Lcom/sec/android/app/dialertab/util/PhoneDisambigDialog;-><init>(Landroid/content/Context;Landroid/database/Cursor;Z)V

    .line 1546
    .local v2, phoneDialog:Lcom/sec/android/app/dialertab/util/PhoneDisambigDialog;
    invoke-virtual {v2}, Lcom/sec/android/app/dialertab/util/PhoneDisambigDialog;->show()V

    goto :goto_0

    .line 1529
    .end local v2           #phoneDialog:Lcom/sec/android/app/dialertab/util/PhoneDisambigDialog;
    .end local v4           #sendSMS:Z
    :cond_7
    const/4 v5, -0x1
...
.method public onContextItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 1563
    .local v3, idxContactId:I
    const/4 v2, 0x0

    .line 1565
    .local v2, contact_Id:I
    iget-boolean v8, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mIsGrid:Z

    if-eqz v8, :cond_0

    .line 1566
    iget v8, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mGridViewSeparator:I

    if-ne v8, v9, :cond_2

    .line 1567
    iput-boolean v11, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mIsFrequentView:Z
    ...
    .line 1569
    :cond_2
    iput-boolean v10, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mIsFrequentView:Z

    goto :goto_0

    .line 1576
    :pswitch_0
    invoke-direct {p0, v11}, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->callOrSmsContact(I)V

    goto :goto_1

    .line 1580
    :pswitch_1
    iget-object v8, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mStrNumber:Ljava/lang/String;

    invoke-static {p0, v8}, Lcom/sec/android/app/dialertab/calllog/CallLogUtil;->editCall(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 1588
    :pswitch_3
    iget-boolean v8, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mIsFrequentView:Z
    ...
    .line 1590
    iget-object v8, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mMCursor:Landroid/database/MergeCursor;

    iget v9, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mItemIndex:I

    invoke-virtual {v8, v9}, Landroid/database/MergeCursor;->moveToPosition(I)Z

    .line 1591
    iget-object v8, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mFreqCursor:Landroid/database/Cursor;
    ...
    invoke-virtual {v8, v3}, Landroid/database/MergeCursor;->getInt(I)I
    ...
    .line 1603
    iget-object v8, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mFavoCursor:Landroid/database/Cursor;
    ...
    .line 1617
    :pswitch_4
    invoke-direct {p0, v9}, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->callOrSmsContact(I)V
    ...
    invoke-static {p0, v8}, Lcom/sec/android/app/dialertab/calllog/CallLogUtil;->blockContact(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p0, v8}, Lcom/sec/android/app/dialertab/calllog/CallLogUtil;->unblockContact(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object v8, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mStrNumber:Ljava/lang/String;
    ...
    .line 1646
    .local v7, where:Ljava/lang/StringBuffer;
    ...
    .line 1654
    iget-object v8, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mMainListView:Landroid/widget/ListView;
    ...
    .line 1637
    .end local v7           #where:Ljava/lang/StringBuffer;
    :cond_7
    iget-object v8, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mStrNumber:Ljava/lang/String;
    ...
    invoke-virtual {v8, v10}, Landroid/database/MergeCursor;->getLong(I)J
    ...
    invoke-virtual {v8, v13}, Landroid/database/MergeCursor;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {v8, v9, v6, v12, v12}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    iget v10, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mItemIndex:I
...
.method public onCreateContextMenu(Landroid/view/ContextMenu;Landroid/view/View;Landroid/view/ContextMenu$ContextMenuInfo;)V
    ...
    const-string v2, "====> mGridViewSeparator = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v2, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mGridViewSeparator:I
    ...
    const-string v2, "====> isFirstFrequent = "
    ...
    .line 1369
    .local v8, menu_call:Ljava/lang/String;
    const/4 v0, 0x0
    ...
    invoke-interface {p1, v0, v1, v2, v8}, Landroid/view/ContextMenu;->add(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    iget-object v6, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mStrNumber:Ljava/lang/String;
    ...
    .end local v2           #projection:[Ljava/lang/String;
    .end local v6           #c:Landroid/database/Cursor;
    .end local v8           #menu_call:Ljava/lang/String;
    .end local v9           #where:Ljava/lang/StringBuffer;
    :cond_f
    iget-object v0, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mstrName:Ljava/lang/String;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    const-class v2, Lcom/sec/android/app/dialertab/frequent/FrequentGridDeleteActivity;
    ...
    iget-boolean v2, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mIsFirstFrequent:Z
    ...
    .end local v0           #i:Landroid/content/Intent;
    const-class v2, Lcom/sec/android/app/dialertab/frequent/FrequentDeleteActivity;
    ...
    .line 1171
    :cond_1
    iput-boolean v4, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mIsFirstFrequent:Z
    ...
    .line 1181
    invoke-virtual {p0, v1}, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->startActivity(Landroid/content/Intent;)V
    ...
    .line 1184
    .end local v1           #intentAdd:Landroid/content/Intent;
    :pswitch_3
    iget-boolean v2, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mIsGrid:Z
    ...
    .line 1190
    :cond_2
    iput-boolean v4, p0, Lcom/sec/android/app/dialertab/frequent/FrequentListActivity;->mIsGrid:Z
