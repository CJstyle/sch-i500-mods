...
# static fields
.field private static final APPLICATION_ICON_SLOT_TAG:Ljava/lang/Object; = null

.field public static final CENTER_APP_ICON_INDEX:I = 0x1

.field public static final COLUMN_NUM:I = 0x3

.field private static final DEBUG:Z = true

.field private static final EMPTY_SLOT_VIEW_TAG:Ljava/lang/Object; = null

.field private static final LOG_TAG:Ljava/lang/String; = "Launcher.TopFourZone"

.field public static final TOPFOURZONE_CELL_Y:I = 0x0

.field public static final TOPFOURZONE_SCREEN:I = -0x1
...
.method arrangeItem(I)V
    ...
    .line 555
    invoke-virtual {p0, p1}, Lcom/sec/android/app/twlauncher/TopFourZone;->getChildAt(I)Landroid/view/View;
    ...
    .line 561
    invoke-virtual {p0, v5}, Lcom/sec/android/app/twlauncher/TopFourZone;->getChildAt(I)Landroid/view/View;
    ...
    .line 579
    invoke-virtual {p0, v6}, Lcom/sec/android/app/twlauncher/TopFourZone;->removeViewAt(I)V

    .line 580
    iget-object v9, p0, Lcom/sec/android/app/twlauncher/TopFourZone;->mVirtualView:[Landroid/view/View;

    aget-object v9, v9, p1

    invoke-virtual {p0, v9, p1}, Lcom/sec/android/app/twlauncher/TopFourZone;->addView(Landroid/view/View;I)V
...
.method changeItem(Landroid/view/View;I)V
    ...
    .line 403
    invoke-virtual {p0, p1}, Lcom/sec/android/app/twlauncher/TopFourZone;->removeItem(Landroid/view/View;)I

    move-result v1

    .line 404
    invoke-virtual {p0, v0}, Lcom/sec/android/app/twlauncher/TopFourZone;->removeItem(Landroid/view/View;)I

    .line 405
    invoke-virtual {p0, v0, v1}, Lcom/sec/android/app/twlauncher/TopFourZone;->addItem(Landroid/view/View;I)Landroid/view/View;

    .line 406
    invoke-virtual {p0, p1, p2}, Lcom/sec/android/app/twlauncher/TopFourZone;->addItem(Landroid/view/View;I)Landroid/view/View;
...
.method public clearApplications()V
    ...
    .prologue
    .line 272
    invoke-virtual {p0}, Lcom/sec/android/app/twlauncher/TopFourZone;->removeAllViews()V
...
.method getIndexOfCell(II)I
    ...
    invoke-virtual {p0, v2}, Lcom/sec/android/app/twlauncher/TopFourZone;->getHitRect(Landroid/graphics/Rect;)V
    ...
    .line 383
    iget v3, p0, Lcom/sec/android/app/twlauncher/TopFourZone;->mChildWidth:I
    ...
    :cond_2
    iget v3, p0, Lcom/sec/android/app/twlauncher/TopFourZone;->mChildHeight:I
...
.method public loadApplications()V
    ...
    .prologue
    .line 220
    const-string v0, "Launcher.TopFourZone"

    const-string v1, "loadApplications()"
...
.method public setEnabledChildAnimation(Z)V
    ...
    .prologue
    .line 441
    iput-boolean p1, p0, Lcom/sec/android/app/twlauncher/TopFourZone;->mEnabledChildAnimation:Z
...
.method public setEnabledDrawing(Z)V
    ...
    .prologue
    .line 445
    iput-boolean p1, p0, Lcom/sec/android/app/twlauncher/TopFourZone;->mEnabledDrawing:Z
...
.method public updateApplications()V
    ...
    .line 239
    invoke-virtual {p0, v1}, Lcom/sec/android/app/twlauncher/TopFourZone;->getChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v1}, Lcom/sec/android/app/twlauncher/TopFourZone;->removeViewAt(I)V
    ...
    invoke-virtual {p0, v3, v1}, Lcom/sec/android/app/twlauncher/TopFourZone;->addView(Landroid/view/View;I)V
    ...
    .end local v2           #tag:Ljava/lang/Object;
    :cond_1
    invoke-virtual {p0}, Lcom/sec/android/app/twlauncher/TopFourZone;->updateBadges()V
