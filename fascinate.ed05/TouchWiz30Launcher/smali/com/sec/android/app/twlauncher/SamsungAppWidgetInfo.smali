...
.method public fireOnPause(Landroid/content/Context;)V
    ...
    .prologue
    .line 79
    iget v8, p0, Lcom/sec/android/app/twlauncher/SamsungAppWidgetInfo;->state:I
    ...
    instance-of v8, p1, Landroid/app/ActivityGroup;

    if-eqz v8, :cond_0

    iget v8, p0, Lcom/sec/android/app/twlauncher/SamsungAppWidgetInfo;->widgetId:I
    ...
    .line 82
    .local v1, ag:Landroid/app/ActivityGroup;
    ...
    iget v10, p0, Lcom/sec/android/app/twlauncher/SamsungAppWidgetInfo;->widgetId:I
    ...
    invoke-virtual {v8, v9}, Landroid/app/LocalActivityManager;->getActivity(Ljava/lang/String;)Landroid/app/Activity;

    move-result-object v2

    .line 84
    .local v2, app:Landroid/app/Activity;
    if-eqz v2, :cond_0
    ...
    .line 88
    .local v7, widgetObserver:Ljava/lang/Class;
    const/4 v5, 0x0
    ...
    const-class v9, Lcom/sec/android/touchwiz/appwidget/IWidgetObserver;
    ...
    iput v8, p0, Lcom/sec/android/app/twlauncher/SamsungAppWidgetInfo;->state:I
