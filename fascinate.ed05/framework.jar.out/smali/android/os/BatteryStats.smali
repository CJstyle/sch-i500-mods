...
.method public final dumpCheckinLocked(Ljava/io/PrintWriter;II)V
    ...
    invoke-virtual {v0, v1, v2, v3}, Landroid/os/BatteryStats;->getWifiRunningTime(JI)J
    ...
    invoke-virtual {v0, v1, v2, v3}, Landroid/os/BatteryStats$Uid;->getWifiTurnedOnTime(JI)J

    move-result-wide v95

    .line 898
    .local v95, wifiTurnedOnTime:J
    ...
    .end local v95           #wifiTurnedOnTime:J
    :cond_1f
    return-void
.end method
...
.method public dumpCheckinLocked(Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 1473
    invoke-virtual {p0, p1, v7, v6}, Landroid/os/BatteryStats;->dumpCheckinLocked(Ljava/io/PrintWriter;II)V
    ...
    invoke-virtual {p0, p1, v5, v6}, Landroid/os/BatteryStats;->dumpCheckinLocked(Ljava/io/PrintWriter;II)V
...
.method public dumpLocked(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {p0, p1, v2, v0, v3}, Landroid/os/BatteryStats;->dumpLocked(Ljava/io/PrintWriter;Ljava/lang/String;II)V
...
.method public final dumpLocked(Ljava/io/PrintWriter;Ljava/lang/String;II)V
    ...
    .line 1022
    .local v85, uidStats:Landroid/util/SparseArray;,"Landroid/util/SparseArray<+Landroid/os/BatteryStats$Uid;>;"
    invoke-virtual/range {v85 .. v85}, Landroid/util/SparseArray;->size()I
    ...
    .line 1082
    .local v25, fullWakeLockTimeTotalMicros:J
    const-wide/16 v39, 0x0

    .line 1084
    .local v39, partialWakeLockTimeTotalMicros:J
    if-gez p4, :cond_5
    ...
    .line 1086
    .local v36, kernelWakelocks:Ljava/util/Map;,"Ljava/util/Map<Ljava/lang/String;+Landroid/os/BatteryStats$Timer;>;"
    ...
    .end local v21           #ent:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/String;+Landroid/os/BatteryStats$Timer;>;"
    .end local v33           #i$:Ljava/util/Iterator;
    .end local v36           #kernelWakelocks:Ljava/util/Map;,"Ljava/util/Map<Ljava/lang/String;+Landroid/os/BatteryStats$Timer;>;"
    :cond_5
    const/16 v35, 0x0
    ...
    check-cast v82, Landroid/os/BatteryStats$Uid;

    .line 1108
    .local v82, u:Landroid/os/BatteryStats$Uid;
    ...
    .line 1111
    invoke-virtual/range {v82 .. v82}, Landroid/os/BatteryStats$Uid;->getWakelockStats()Ljava/util/Map;
    ...
    check-cast v101, Landroid/os/BatteryStats$Uid$Wakelock;

    .line 1117
    .local v101, wl:Landroid/os/BatteryStats$Uid$Wakelock;
    const/4 v6, 0x1
    ...
    .line 1124
    .local v41, partialWakeTimer:Landroid/os/BatteryStats$Timer;
    if-eqz v41, :cond_6
    ...
    .end local v27           #fullWakeTimer:Landroid/os/BatteryStats$Timer;
    .end local v33           #i$:Ljava/util/Iterator;
    .end local v41           #partialWakeTimer:Landroid/os/BatteryStats$Timer;
    .end local v101           #wl:Landroid/os/BatteryStats$Uid$Wakelock;
    :cond_8
    ...
    .line 1132
    .end local v82           #u:Landroid/os/BatteryStats$Uid;
    ...
    .line 1241
    .restart local v82       #u:Landroid/os/BatteryStats$Uid;
    ...
    .line 1256
    :cond_17
    invoke-virtual/range {v82 .. v82}, Landroid/os/BatteryStats$Uid;->hasUserActivity()Z
    ...
    const-string v6, "    Turned Wifi On: "
    ...
    .line 1301
    .restart local v101       #wl:Landroid/os/BatteryStats$Uid$Wakelock;
    const-string v11, ": "
    ...
    .end local v101           #wl:Landroid/os/BatteryStats$Uid$Wakelock;
    :cond_1f
    invoke-virtual/range {v82 .. v82}, Landroid/os/BatteryStats$Uid;->getSensorStats()Ljava/util/Map;
    ...
    .line 1331
    invoke-virtual/range {v56 .. v56}, Landroid/os/BatteryStats$Uid$Sensor;->getHandle()I
    ...
    .line 1363
    .end local v20           #ent:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/Integer;+Landroid/os/BatteryStats$Uid$Sensor;>;"
    .end local v30           #handle:I
    .end local v33           #i$:Ljava/util/Iterator;
    .end local v56           #se:Landroid/os/BatteryStats$Uid$Sensor;
    .end local v57           #sensorNumber:I
    .end local v73           #timer:Landroid/os/BatteryStats$Timer;
    :cond_23
    invoke-virtual/range {v82 .. v82}, Landroid/os/BatteryStats$Uid;->getProcessStats()Ljava/util/Map;
    ...
    :cond_26
    invoke-virtual/range {v82 .. v82}, Landroid/os/BatteryStats$Uid;->getPackageStats()Ljava/util/Map;

    move-result-object v38

    .line 1392
    .local v38, packageStats:Ljava/util/Map;,"Ljava/util/Map<Ljava/lang/String;+Landroid/os/BatteryStats$Uid$Pkg;>;"
    ...
    check-cast v45, Landroid/os/BatteryStats$Uid$Pkg;

    .line 1398
    .local v45, ps:Landroid/os/BatteryStats$Uid$Pkg;
    move-object/from16 v0, v45
    ...
    .line 1404
    :cond_27
    invoke-virtual/range {v45 .. v45}, Landroid/os/BatteryStats$Uid$Pkg;->getServiceStats()Ljava/util/Map;
    ...
    .end local v22           #ent:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/String;+Landroid/os/BatteryStats$Uid$Pkg;>;"
    .end local v45           #ps:Landroid/os/BatteryStats$Uid$Pkg;
    ...
    .line 1437
    .end local v28           #fullWifiLockOnTime:J
    .end local v38           #packageStats:Ljava/util/Map;,"Ljava/util/Map<Ljava/lang/String;+Landroid/os/BatteryStats$Uid$Pkg;>;"
    ...
    .end local v67           #tcpReceived:J
    .end local v69           #tcpSent:J
    .end local v82           #u:Landroid/os/BatteryStats$Uid;
    .end local v83           #uid:I
    .end local v84           #uidActivity:Z
    .end local v89           #wakelocks:Ljava/util/Map;,"Ljava/util/Map<Ljava/lang/String;+Landroid/os/BatteryStats$Uid$Wakelock;>;"
    .end local v99           #wifiTurnedOnTime:J
    :cond_2d
    return-void
.end method
