...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 58
    sget-boolean v1, Lcom/android/phone/OtaStartupReceiver;->DBG:Z

    if-eqz v1, :cond_0

    const-string v1, "OtaStartupReceiver"

    const-string v1, "Not a CDMA phone, no need to process OTA"
    ...
    const-string v1, "Postponing CDMA provisioning until wizard runs"
    ...
    .line 68
    :cond_2
    const-string v1, "com.android.phone.OTA_CALL_ACTIVATION.SETUPWIZARD"
    ...
    invoke-static {v1, v2, v3, v0}, Lcom/android/phone/OtaUtils;->maybeDoOtaCall(Landroid/content/Context;Landroid/os/Handler;IZ)Z
