...
.method public run()V
    ...
    invoke-static {v9}, Landroid/server/BluetoothService;->access$1500(Landroid/server/BluetoothService;)I
    ...
    invoke-static {v9, v13}, Landroid/server/BluetoothService;->access$1700(Landroid/server/BluetoothService;Z)V

    .line 993
    :cond_7
    iget-object v9, p0, Landroid/server/BluetoothService$EnableThread;->this$0:Landroid/server/BluetoothService;

    invoke-static {v9, v12}, Landroid/server/BluetoothService;->access$1802(Landroid/server/BluetoothService;Z)Z

    .line 994
    iget-object v9, p0, Landroid/server/BluetoothService$EnableThread;->this$0:Landroid/server/BluetoothService;

    invoke-static {v9}, Landroid/server/BluetoothService;->access$1900(Landroid/server/BluetoothService;)Landroid/server/BluetoothService$BondState;
    ...
    invoke-static {v9}, Landroid/server/BluetoothService;->access$2000(Landroid/server/BluetoothService;)V
    ...
    invoke-static {v9}, Landroid/server/BluetoothService;->access$2100(Landroid/server/BluetoothService;)Lcom/android/internal/app/IBatteryStats;
    ...
    invoke-static {v9, v10}, Landroid/server/BluetoothService;->access$2202(Landroid/server/BluetoothService;Landroid/server/BluetoothService$EnableThread;)Landroid/server/BluetoothService$EnableThread;
    ...
    :goto_5
    invoke-static {v9, v10}, Landroid/server/BluetoothService;->access$2300(Landroid/server/BluetoothService;I)V
    ...
    invoke-static {v9, v10, v11}, Landroid/server/BluetoothService;->access$2400(Landroid/server/BluetoothService;II)Z
