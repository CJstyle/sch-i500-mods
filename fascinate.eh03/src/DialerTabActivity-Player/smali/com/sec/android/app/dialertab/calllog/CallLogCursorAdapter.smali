...
.method private formatDate(J)Ljava/lang/String;
    ...
    .line 807
    iget-object v1, p0, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->mCalendar:Ljava/util/Calendar;
    ...
    .line 810
    sget-boolean v3, Lcom/sec/android/app/dialertab/DialerTabActivity;->m24TimeFormat:Z
    ...
    .line 825
    :cond_2
    iget-object v3, p0, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->mCalendar:Ljava/util/Calendar;
...
.method private getSweptView(ILandroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, v2, v0, v1}, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->bindView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    invoke-virtual {v1, v3}, Lcom/sec/android/app/dialertab/calllog/CallLogCursorWrapper;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {v1, v4}, Lcom/sec/android/app/dialertab/calllog/CallLogCursorWrapper;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {v1, v6}, Lcom/sec/android/app/dialertab/calllog/CallLogCursorWrapper;->getInt(I)I
    ...
    check-cast v1, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$ContactInfo;

    .line 892
    if-nez v1, :cond_2

    .line 895
    sget-object v1, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$ContactInfo;->EMPTY:Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$ContactInfo;

    .line 896
    iget-object v7, p0, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->mContactInfoCache:Ljava/util/HashMap;
    ...
    invoke-direct {p0, v3, v4, v6, v7}, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->enqueueRequest(Ljava/lang/String;Ljava/lang/String;J)V
    ...
    .line 922
    :goto_1
    iget-object v0, v1, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$ContactInfo;->name:Ljava/lang/String;
    ...
    .line 926
    :cond_1
    invoke-direct {p0, v2, p1}, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->attachCloseItemBtnListener(Landroid/view/View;I)V

    .line 927
    iget-object v0, p0, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->mCursor:Lcom/sec/android/app/dialertab/calllog/CallLogCursorWrapper;

    invoke-direct {p0, v0, v2, p1}, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->attachCallBtnListener(Landroid/database/Cursor;Landroid/view/View;I)V

    .line 928
    iget-object v0, p0, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->mCursor:Lcom/sec/android/app/dialertab/calllog/CallLogCursorWrapper;

    invoke-direct {p0, v0, v2, p1}, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->attachMessageBtnListener(Landroid/database/Cursor;Landroid/view/View;I)V

    .line 929
    iput-object v2, p0, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->mCurrentSweptView:Landroid/view/View;
    ...
    .line 898
    :cond_2
    sget-object v7, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$ContactInfo;->EMPTY:Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$ContactInfo;

    if-eq v1, v7, :cond_0

    .line 903
    iget-object v5, v1, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$ContactInfo;->name:Ljava/lang/String;
    ...
    invoke-direct {p0, v3, v4, v5, v6}, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->enqueueRequest(Ljava/lang/String;Ljava/lang/String;J)V
...
.method private handleItemButton(Landroid/view/View;Landroid/content/Context;II)V
    ...
    iput-object v2, p0, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->mTimer:Ljava/util/Timer;
    ...
    invoke-virtual {v0, p3}, Lcom/sec/android/app/dialertab/calllog/CallLogCursorWrapper;->moveToPosition(I)Z

    .line 1010
    iget-object v0, p0, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->mCursor:Lcom/sec/android/app/dialertab/calllog/CallLogCursorWrapper;

    invoke-virtual {v0, v4}, Lcom/sec/android/app/dialertab/calllog/CallLogCursorWrapper;->getString(I)Ljava/lang/String;

    move-result-object v0

    .line 1011
    iget-object v1, p0, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->mTimer:Ljava/util/Timer;

    new-instance v2, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$CallTask;

    iget-object v3, p0, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->mContext:Landroid/content/Context;

    invoke-direct {v2, p0, v3, v0}, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$CallTask;-><init>(Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;Landroid/content/Context;Ljava/lang/String;)V
    ...
    new-instance v2, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$SendMessageTask;

    iget-object v3, p0, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->mContext:Landroid/content/Context;

    invoke-direct {v2, p0, v3, v0}, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$SendMessageTask;-><init>(Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;Landroid/content/Context;Ljava/lang/String;)V
...
.method private updateItem(Landroid/view/View;Landroid/content/Context;II)V
    ...
    .line 1086
    new-instance v1, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$animationListener;

    const/4 v2, 0x2

    invoke-direct {v1, p0, p3, v2, v4}, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$animationListener;-><init>(Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;IILcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$1;)V
    ...
    .line 1094
    new-instance v2, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$animationListener;

    const/4 v3, 0x1

    invoke-direct {v2, p0, p3, v3, v4}, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$animationListener;-><init>(Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;IILcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$1;)V
...
.method public GetCityID(Landroid/database/Cursor;ILjava/lang/String;)Lcom/cequint/cityid/android/CityIdContact;
    ...
    :goto_0
    invoke-static {v0, p3, v1}, Lcom/cequint/cityid/android/CityIdContact;->doLookup(Landroid/content/Context;Ljava/lang/String;Z)Lcom/cequint/cityid/android/CityIdContact;
...
.method public closeSweptItem()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->mCurrentSweptView:Landroid/view/View;
    ...
    .line 1150
    iget-object v2, p0, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;->mCurrentSweptView:Landroid/view/View;
    ...
    .line 1151
    new-instance v3, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$animationListener;

    const/4 v4, 0x1

    const/4 v5, 0x0

    invoke-direct {v3, p0, v1, v4, v5}, Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$animationListener;-><init>(Lcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter;IILcom/sec/android/app/dialertab/calllog/CallLogCursorAdapter$1;)V
