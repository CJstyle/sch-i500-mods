...
.field private static final DTMF_TONE_LENGTH:Ljava/lang/String; = "com.android.phone.DtmfToneLength"

.field static final EVENT_PST_DEL_ALL_CONTACTS:I = 0x0

.field static final EVENT_PST_ERROR:I = 0xff

.field static final EVENT_PST_GET_ITEM_DATA:I = 0x1

.field static final EVENT_PST_PEMISSION_CHANGE:I = 0x3

.field static final EVENT_PST_SET_ITEM_DATA:I = 0x2
...
.field mPSTHandler:Landroid/os/Handler;
...
.method public constructor <init>(Landroid/content/Context;II)V
    ...
    .line 754
    const-string v3, "com.android.phone.DtmfToneLength"
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/RIL;->mPSTHandler:Landroid/os/Handler;
...
.method static synthetic access$100(Lcom/android/internal/telephony/RIL;)Landroid/content/SharedPreferences;
    .locals 1
    .parameter "x0"

    .prologue
    .line 266
    iget-object v0, p0, Lcom/android/internal/telephony/RIL;->mPref:Landroid/content/SharedPreferences;

    return-object v0
.end method

.method static synthetic access$102(Lcom/android/internal/telephony/RIL;Landroid/content/SharedPreferences;)Landroid/content/SharedPreferences;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 266
    iput-object p1, p0, Lcom/android/internal/telephony/RIL;->mPref:Landroid/content/SharedPreferences;

    return-object p1
.end method

.method static synthetic access$200(Lcom/android/internal/telephony/RIL;)Landroid/content/SharedPreferences$Editor;
    .locals 1
    .parameter "x0"

    .prologue
    .line 266
    iget-object v0, p0, Lcom/android/internal/telephony/RIL;->mEdit:Landroid/content/SharedPreferences$Editor;

    return-object v0
.end method

.method static synthetic access$202(Lcom/android/internal/telephony/RIL;Landroid/content/SharedPreferences$Editor;)Landroid/content/SharedPreferences$Editor;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 266
    iput-object p1, p0, Lcom/android/internal/telephony/RIL;->mEdit:Landroid/content/SharedPreferences$Editor;
...
.method static synthetic access$700(Lcom/android/internal/telephony/RIL;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method private processUnsolicited(Landroid/os/Parcel;)V
    ...
    const-string v30, "Unrecognized unsol response: "
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/internal/telephony/CommandsInterface$RadioState;->toString()Ljava/lang/String;
    ...
    .local v22, ret:Ljava/util/ArrayList;
    goto/16 :goto_1

    .line 3911
    .end local v22           #ret:Ljava/util/ArrayList;
    :sswitch_1d
    ...
    invoke-virtual/range {v28 .. v29}, Landroid/os/RegistrantList;->notifyRegistrants(Landroid/os/AsyncResult;)V
    ...
    invoke-virtual/range {v28 .. v29}, Landroid/os/Registrant;->notifyRegistrant(Landroid/os/AsyncResult;)V
    ...
    const-string v29, " NEW_SMS_ON_SIM ERROR with wrong length "
    ...
    invoke-static/range {v16 .. v16}, Landroid/telephony/gsm/CbMessage;->newCBMessage(Ljava/lang/String;)Landroid/telephony/gsm/CbMessage;
    ...
    .end local v16           #pdu:Ljava/lang/String;
    :sswitch_3f
    const-string v28, "RILJ"

    const-string v29, "Received DEVICE READY NOTIFICATION"
    ...
    invoke-virtual/range {v28 .. v28}, Landroid/os/Registrant;->notifyRegistrant()V
    ...
    const-string v30, "[slyph]RIL_UNSOL_VOICE_PRIVACY_CHANGED "
    ...
    const-string v29, "InCall VoicePrivacy is enabled"
    ...
    const-string v29, "InCall VoicePrivacy is disabled"
    ...
    check-cast v18, Lcom/android/internal/telephony/cdma/CdmaInformationRecords;

    .line 4348
    .local v18, rec:Lcom/android/internal/telephony/cdma/CdmaInformationRecords;
    move-object/from16 v0, p0
    ...
    .end local v18           #rec:Lcom/android/internal/telephony/cdma/CdmaInformationRecords;
    :catch_1
    move-exception v9
    ...
    const-string v29, "Unexpected exception casting to listInfoRecs"
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/RIL;->mOmaDmSendDataRegistrants:Landroid/os/RegistrantList;
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/RIL;->mPSTHandler:Landroid/os/Handler;
    ...
    .line 4479
    .end local v8           #data_len:I
    .end local v13           #msg:Landroid/os/Message;
    :sswitch_58
    const-string v28, "RIL_UNSOL_SYSTEM_REBOOT"
    ...
    invoke-virtual {v12}, Landroid/os/PowerManager;->systemReboot()V
...
.method static requestToString(I)Ljava/lang/String;
    ...
    .line 5387
    :sswitch_7f
    const-string v0, "RIL_REQUEST_PST_RESP_GET_ITEM_DATA"
...
.method private responseCallList(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    :goto_4
    iput-boolean v6, v0, Lcom/android/internal/telephony/DriverCall;->isVideo:Z
    ...
    .restart local v5       #voiceSettings:I
    :cond_2
    move v6, v9
...
.method public dial(Ljava/lang/String;ILandroid/os/Message;)V
    ...
    .line 1843
    .local v0, isEmergency:I
    :goto_0
    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "dial >> isEmergency == "
...
.method public sendDtmf(CLandroid/os/Message;)V
    ...
    .line 2186
    iget-object v3, p0, Lcom/android/internal/telephony/RIL;->mContext:Landroid/content/Context;

    const-string/jumbo v4, "ril_pref"

    iget-object v5, p0, Lcom/android/internal/telephony/RIL;->mContext:Landroid/content/Context;
...
.method public sendPSTGetItemData(II)V
    .locals 3
    .parameter "item_idx"
    .parameter "data"
...
.method public sendPSTGetItemData(IILjava/lang/String;)V
    .locals 3
    .parameter "item_idx"
    .parameter "data_len"
    .parameter "data"
...
.method public setModemPower(ZLandroid/os/Message;)V
    ...
    .line 2662
    iget-object v2, p0, Lcom/android/internal/telephony/RIL;->mStateMonitor:Ljava/lang/Object;

    monitor-enter v2

    .line 2663
    :try_start_0
    iget-object v3, p0, Lcom/android/internal/telephony/RIL;->mState:Lcom/android/internal/telephony/CommandsInterface$RadioState;
    ...
    iget v4, p0, Lcom/android/internal/telephony/RIL;->mCdmaSubscription:I
