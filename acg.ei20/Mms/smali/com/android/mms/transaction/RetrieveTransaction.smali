...
.method public constructor <init>(Landroid/content/Context;ILcom/android/mms/transaction/TransactionSettings;Ljava/lang/String;)V
    ...
    const-string v9, "X-Mms-Content-Location: "

    const-string v8, "Initializing from X-Mms-Content-Location is abandoned!"

    const-string v5, "Mms/RetrieveTransaction"
    ...
    iput-object v3, p0, Lcom/android/mms/transaction/RetrieveTransaction;->mUri:Landroid/net/Uri;

    .line 88
    iget-object v3, p0, Lcom/android/mms/transaction/RetrieveTransaction;->mUri:Landroid/net/Uri;

    invoke-static {p1, v3}, Lcom/android/mms/transaction/RetrieveTransaction;->getTransactionId(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v3}, Lcom/android/mms/transaction/RetrieveTransaction;->getContentLocation(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;

    move-result-object v0

    .line 91
    .local v0, checkContentLocation:Ljava/lang/String;
    const/4 v2, 0x0
    ...
    .line 95
    .local v1, isSimbol:I
    const-string v3, "Mms/RetrieveTransaction"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "checkContentLocation : "
    ...
    const-string v4, "Location Result mid  : "
    ...
    const-string v4, "X-Mms-Content-Location: "
    ...
    invoke-virtual {p0, v3}, Lcom/android/mms/transaction/RetrieveTransaction;->attach(Lcom/android/mms/transaction/Observer;)V

    .line 152
    return-void

    .line 111
    .restart local v1       #isSimbol:I
    .restart local v2       #tId:Ljava/lang/String;
    :cond_3
    ...
    .line 122
    .end local v0           #checkContentLocation:Ljava/lang/String;
    .end local v1           #isSimbol:I
    .end local v2           #tId:Ljava/lang/String;
    :cond_5
    new-instance v3, Ljava/lang/IllegalArgumentException;

    const-string v4, "Initializing from X-Mms-Content-Location is abandoned!"
    ...
    .line 130
    .restart local v0       #checkContentLocation:Ljava/lang/String;
    new-instance v3, Ljava/lang/StringBuilder;
    ...
    const-string v5, "X-Mms-Content-Location: "
...
.method private static getTransactionId(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    .locals 9
    .parameter "context"
    .parameter "uri"
    .annotation system Ldalvik/annotation/Throws;
    ...
    const-string v2, "Cannot get transaction id from: "
...
.method public run()V
    ...
    invoke-virtual {p0, v7}, Lcom/android/mms/transaction/RetrieveTransaction;->getPdu(Ljava/lang/String;)[B
    ...
    check-cast v5, Lcom/google/android/mms/pdu/RetrieveConf;

    .line 212
    .local v5, retrieveConf:Lcom/google/android/mms/pdu/RetrieveConf;
    if-nez v5, :cond_1
    ...
    .line 254
    .end local v4           #resp:[B
    .end local v5           #retrieveConf:Lcom/google/android/mms/pdu/RetrieveConf;
    :catch_0
    move-exception v7
    ...
    invoke-static {v7}, Lcom/android/mms/transaction/HttpUtils;->checkIOExceptionHttpErrorCode(Ljava/lang/String;)I

    move-result v1

    .line 258
    .local v1, httpErrorcode:I
    ...
    const-string v9, "IOException - Http Error Code : "
    ...
    .end local v1           #httpErrorcode:I
    :goto_0
    return-void

    .line 216
    .restart local v4       #resp:[B
    .restart local v5       #retrieveConf:Lcom/google/android/mms/pdu/RetrieveConf;
    :cond_1
    const/4 v2, 0x0
    ...
    invoke-static {v7, v2, v8}, Lcom/android/mms/transaction/MessagingNotification;->updateHistoryForMms(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;)Z

    .line 253
    :cond_2
    invoke-direct {p0, v5}, Lcom/android/mms/transaction/RetrieveTransaction;->sendAcknowledgeInd(Lcom/google/android/mms/pdu/RetrieveConf;)V
    :try_end_2
    ...
    invoke-virtual {v3, v5, v7}, Lcom/google/android/mms/pdu/PduPersister;->persist(Lcom/google/android/mms/pdu/GenericPdu;Landroid/net/Uri;)Landroid/net/Uri;
    ...
    iget-boolean v9, p0, Lcom/android/mms/transaction/RetrieveTransaction;->mLocked:Z

    invoke-static {v7, v2, v8, v9}, Lcom/android/mms/transaction/RetrieveTransaction;->updateContentLocation(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Z)V
    :try_end_3
    ...
    .line 268
    const-string v8, "Mms/RetrieveTransaction"

    const-string v9, "Retrieval failed."
