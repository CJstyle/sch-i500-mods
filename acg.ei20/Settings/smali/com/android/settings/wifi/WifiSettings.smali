...
# static fields
.field private static final ACCESS_PNTS:Ljava/lang/String; = "access_points"

.field private static final KEY_ADVANCED_NETWORK:Ljava/lang/String; = "advanced_network"

.field private static final KEY_MANAGE_NETWORK:Ljava/lang/String; = "add_manage_network"

.field private static final KEY_NO_NETWORK:Ljava/lang/String; = "no_network_found"

.field private static final KEY_ONLY_ACCESS_POINTS:Ljava/lang/String; = "only_access_points"

.field private static final KEY_SEARCH_NETWORK:Ljava/lang/String; = "search_network"
...
.field private static final WIFI_PREF_SETTINGS:Ljava/lang/String; = "wifi_pref_settings"
...
.method private handleEvent(Landroid/content/Intent;)V
    ...
    .line 1266
    iget-object v1, p0, Lcom/android/settings/wifi/WifiSettings;->mWifiSettingsprefscrn:Landroid/preference/PreferenceScreen;
    ...
    iget-object v2, p0, Lcom/android/settings/wifi/WifiSettings;->mprefcategory:Landroid/preference/PreferenceCategory;
...
.method private handleMore()V
    ...
    const-string v1, "************** on click add button ****************"
...
.method private saveNetwork(Landroid/net/wifi/WifiConfiguration;Z)V
    ...
    .line 1083
    .local v3, newNetId:I
    iget-object v4, p0, Lcom/android/settings/wifi/WifiSettings;->rememberedAccessPoints:Ljava/util/List;
    ...
    invoke-virtual {v4, p1}, Landroid/net/wifi/WifiManager;->updateNetwork(Landroid/net/wifi/WifiConfiguration;)I
    ...
    const-string v5, "saveNetwork():newNetId = "
    ...
    invoke-direct {p0, v4}, Lcom/android/settings/wifi/WifiSettings;->connect(I)V
...
.method private updateAccessPoints()V
    ...
    const-string v18, "updateAccessPoints()"
    ...
    .line 1133
    .local v7, detectedAccessPoints:Ljava/util/List;,"Ljava/util/List<Lcom/android/settings/wifi/AccessPoint;>;"
    ...
    iput v0, v1, Lcom/android/settings/wifi/WifiSettings;->mLastPriority:I

    .line 1136
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings/wifi/WifiSettings;->rememberedAccessPoints:Ljava/util/List;
    ...
    iget v0, v0, Lcom/android/settings/wifi/WifiSettings;->mLastPriority:I
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/settings/wifi/AccessPoint;-><init>(Landroid/content/Context;Landroid/net/wifi/WifiConfiguration;)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/settings/wifi/AccessPoint;->update(Landroid/net/wifi/WifiInfo;Landroid/net/NetworkInfo$DetailedState;)V
    ...
    iget-boolean v0, v0, Lcom/android/settings/wifi/WifiSettings;->mResetNetworks:Z
    ...
    .line 1174
    .local v6, configuredAP:Lcom/android/settings/wifi/AccessPoint;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v3, v14}, Lcom/android/settings/wifi/AccessPoint;->update(Landroid/net/wifi/ScanResult;)Z
    ...
    .line 1205
    new-instance v17, Lcom/android/settings/wifi/AccessPoint;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/settings/wifi/AccessPoint;-><init>(Landroid/content/Context;Landroid/net/wifi/ScanResult;)V
    ...
    .line 1212
    .end local v6           #configuredAP:Lcom/android/settings/wifi/AccessPoint;
    .end local v8           #duplicate:Z
    .end local v9           #found:Z
    .end local v12           #i$:Ljava/util/Iterator;
    .end local v13           #indx:I
    .end local v14           #result:Landroid/net/wifi/ScanResult;
    .end local v16           #temp:[Ljava/lang/String;
    :cond_d
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings/wifi/WifiSettings;->mAccessPoints:Lcom/android/settings/ProgressCategory;

    move-object/from16 v17, v0

    invoke-virtual/range {v17 .. v17}, Lcom/android/settings/ProgressCategory;->removeAll()V
    ...
    invoke-virtual/range {v17 .. v18}, Lcom/android/settings/ProgressCategory;->setProgress(Z)V

    .line 1214
    move-object/from16 v0, p0

    iget-boolean v0, v0, Lcom/android/settings/wifi/WifiSettings;->manage:Z
...
.method public onBackPressed()V
    ...
    .line 1466
    iget-boolean v1, p0, Lcom/android/settings/wifi/WifiSettings;->manage:Z
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .line 593
    iget-object v9, p0, Lcom/android/settings/wifi/WifiSettings;->mSelected:Lcom/android/settings/wifi/AccessPoint;
    ...
    :goto_0
    sget-boolean v9, Lcom/android/settings/wifi/WifiSettings;->manageNetwork:Z
    ...
    iget-boolean v9, v9, Lcom/android/settings/wifi/WifiDialog;->edit:Z
    ...
    const-string v11, "MangeNetwork dialog bttn clicked: button = "
    ...
    iget-object v10, p0, Lcom/android/settings/wifi/WifiSettings;->mSelected:Lcom/android/settings/wifi/AccessPoint;
    ...
    invoke-direct {p0, v9}, Lcom/android/settings/wifi/WifiSettings;->connect(I)V
    ...
    invoke-direct {p0, v9, v10}, Lcom/android/settings/wifi/WifiSettings;->showDialog(Lcom/android/settings/wifi/AccessPoint;Z)V
    ...
    invoke-direct {p0, v9}, Lcom/android/settings/wifi/WifiSettings;->forget(I)V
    ...
    invoke-virtual {v9, v10}, Lcom/android/settings/ProgressCategory;->removePreference(Landroid/preference/Preference;)Z
    ...
    sget v9, Lcom/android/settings/wifi/WifiSettings;->forget_network:I
    ...
    sput-object v9, Lcom/android/settings/wifi/WifiDialog;->ConnectedPassword:Ljava/lang/String;
    ...
    sget v9, Lcom/android/settings/wifi/WifiSettings;->edit_network:I
    ...
    const-string v10, "button == WifiDialog.BUTTON_FORGET"
    ...
    sget-boolean v9, Lcom/android/settings/wifi/WifiSettings;->view:Z
    ...
    const-string v10, "button == WifiDialog.BUTTON_VIEW"
    ...
    invoke-direct {p0, v9, v10, v11, v12}, Lcom/android/settings/wifi/WifiSettings;->showDialog(Lcom/android/settings/wifi/AccessPoint;ZZZ)V

    .line 628
    const/4 v9, 0x0

    sput-boolean v9, Lcom/android/settings/wifi/WifiSettings;->view:Z
    ...
    const-string v10, "button == WifiDialog.BUTTON_SUBMIT/BUTTON_CONNECT"

    invoke-static {v9, v10}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 632
    sget-object v7, Lcom/android/settings/wifi/WifiDialog;->ConnectedPassword:Ljava/lang/String;

    .line 633
    .local v7, previousPass:Ljava/lang/String;
    const-string v9, "WifiSettings"
    ...
    const-string v11, "previous Password: "
    ...
    invoke-virtual {v9}, Lcom/android/settings/wifi/WifiDialog;->getConfig()Landroid/net/wifi/WifiConfiguration;
    ...
    sget-object v11, Lcom/android/settings/wifi/WifiDialog;->ConnectedPassword:Ljava/lang/String;
    ...
    .line 637
    .local v8, sChangedpassword:Ljava/lang/String;
    iget-object v9, p0, Lcom/android/settings/wifi/WifiSettings;->mDialog:Lcom/android/settings/wifi/WifiDialog;

    iget-object v9, v9, Lcom/android/settings/wifi/WifiDialog;->mSsid:Landroid/widget/TextView;
    ...
    sput-object v9, Lcom/android/settings/wifi/WifiDialog;->changedssid:Ljava/lang/String;
    ...
    iget v9, v9, Lcom/android/settings/wifi/WifiDialog;->mSecurity:I
    ...
    const-string v11, "nSecuritysame: "
    ...
    .line 648
    sget-object v9, Lcom/android/settings/wifi/WifiDialog;->ConnectedPassword:Ljava/lang/String;
    ...
    const-string v11, "nPasswordsame: "
    ...
    invoke-direct {p0, v9}, Lcom/android/settings/wifi/WifiSettings;->requireKeyStore(Landroid/net/wifi/WifiConfiguration;)Z
    ...
    const-string v10, "resetRetryDialogVariable in onclick "
    ...
    .line 646
    .end local v4           #nPasswordsame:Z
    .end local v5           #nSecuritysame:Z
    :cond_b
    const/4 v9, 0x0
    ...
    .line 664
    .restart local v4       #nPasswordsame:Z
    .restart local v5       #nSecuritysame:Z
    :cond_d
    ...
    const-string v10, " mSelected != null"
    ...
    const-string v10, " Uzzal EDIT--> SAVED clicked."
    ...
    invoke-direct {p0, v0, v9}, Lcom/android/settings/wifi/WifiSettings;->saveNetwork(Landroid/net/wifi/WifiConfiguration;Z)V
    ...
    .line 676
    .local v3, messageRes:Ljava/lang/String;
    const/4 v9, 0x1
    ...
    .line 684
    .end local v3           #messageRes:Ljava/lang/String;
    :cond_10
    iget v9, p0, Lcom/android/settings/wifi/WifiSettings;->networkIdforRetry:I
    ...
    const-string v10, "networkIdforRetry != -1"

    invoke-static {v9, v10}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 686
    iget-object v9, p0, Lcom/android/settings/wifi/WifiSettings;->configForRetry:Landroid/net/wifi/WifiConfiguration;

    iget-object v10, v0, Landroid/net/wifi/WifiConfiguration;->preSharedKey:Ljava/lang/String;
    ...
    iget v10, p0, Lcom/android/settings/wifi/WifiSettings;->networkIdforRetry:I

    iput v10, v9, Landroid/net/wifi/WifiConfiguration;->networkId:I
    ...
    invoke-virtual {v9, v0}, Landroid/net/wifi/WifiManager;->updateNetwork(Landroid/net/wifi/WifiConfiguration;)I
    ...
    iput v6, p0, Lcom/android/settings/wifi/WifiSettings;->networkIdforRetry:I
    ...
    invoke-virtual {v9, v6, v10}, Landroid/net/wifi/WifiManager;->enableNetwork(IZ)Z
    ...
    .line 719
    invoke-direct {p0, v6}, Lcom/android/settings/wifi/WifiSettings;->connect(I)V

    .line 720
    const-string v9, "WifiSettings"

    const-string v10, "Uzzal if ;"
    ...
    .line 723
    invoke-direct {p0, v2}, Lcom/android/settings/wifi/WifiSettings;->handleEvent(Landroid/content/Intent;)V
    ...
    invoke-direct {p0, v9, v10}, Lcom/android/settings/wifi/WifiSettings;->updateConnectionState(Landroid/net/NetworkInfo$DetailedState;Z)V
    ...
    .line 736
    .restart local v3       #messageRes:Ljava/lang/String;
    const/4 v9, 0x1
    ...
    sput-object v9, Lcom/android/settings/wifi/WifiDialog;->ConnectedCorrectPassword:Ljava/lang/String;
    ...
    const-string v11, "ConnectedCorrectPassword ="

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    sget-object v11, Lcom/android/settings/wifi/WifiDialog;->ConnectedCorrectPassword:Ljava/lang/String;

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    const-string v11, " connected pwd="
    ...
    .end local v7           #previousPass:Ljava/lang/String;
    .end local v8           #sChangedpassword:Ljava/lang/String;
    :cond_18
    const/4 v9, -0x3
    ...
    const-string v10, "onClick() BUTTON_CONNECTED_EDIT"
    ...
    iget-object v9, v9, Lcom/android/settings/wifi/WifiDialog;->mPassword:Landroid/widget/EditText;
    ...
    sput-boolean v9, Lcom/android/settings/wifi/WifiSettings;->edit:Z

    .line 767
    const/4 v9, 0x0

    sput v9, Lcom/android/settings/wifi/WifiSettings;->edit_network:I
    ...
    const-string v10, " Uzzal  mDialog.mPassword is null 1 "
    ...
    const-string v10, "onClick() WPS_PIN"
    ...
    invoke-direct {p0, v9}, Lcom/android/settings/wifi/WifiSettings;->wpsPinConnect(Lcom/android/settings/wifi/AccessPoint;)Z
    ...
    invoke-direct {p0, v9}, Lcom/android/settings/wifi/WifiSettings;->showProgressDialog(I)V
    ...
    invoke-direct {p0, v9}, Lcom/android/settings/wifi/WifiSettings;->showWpsToast(I)V
    ...
    sget-boolean v9, Lcom/android/settings/wifi/WifiSettings;->edit:Z
    ...
    const-string v10, "button == WifiDialog.BUTTON_EDIT"
    ...
    const-string v10, " Uzzal  mDialog.mPassword is null  "
    ...
    const-string v10, "button == WifiDialog.BUTTON_EDIT NW"
    ...
    const-string v10, "button == WifiDialog.BUTTON_NEGATIVE"
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 451
    .end local v6           #ManageConnectable:Z
    :cond_2
    const/4 v6, 0x0

    .restart local v6       #ManageConnectable:Z
    goto :goto_2
    ...
    invoke-virtual {p0, v9}, Lcom/android/settings/wifi/WifiSettings;->getString(I)Ljava/lang/String;
